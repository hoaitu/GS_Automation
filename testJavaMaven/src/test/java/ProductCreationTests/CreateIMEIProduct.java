...
public class CreateIMEIProduct extends BaseTest {
    String name;
    String pass;
    String productName;
    ...
    double costPrice;
    Map<String, List<String>> branchIMEIs;
    ...
    public void setupTest() {
        ...
        branchIMEIs = new HashMap<>();
        branchIMEIs.put("Conan Store", Arrays.asList("IMEI001", "IMEI002"));
        branchIMEIs.put("hue", Arrays.asList("IMEI003")); // "hue" may be disabled
        orgPrice = 50000;
        discountPrice = 40000;
        costPrice = 30000;
    }
    ...
    @Test
    public void testCreateIMEIProduct(){
        if (ExtentListener.getCurrentTest() != null) {
            ExtentListener.getCurrentTest().assignCategory("testCreateIMEIProduct");
            ExtentListener.getCurrentTest().getModel().setDescription("testCreateIMEIProduct description");
        }
...
//        TODO: need to be enhance
//        productPage.addIMEIForBranches(branchIMEIs);
