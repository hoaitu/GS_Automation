...
public class CreateProductHiddenTest extends BaseTest {
    String name;
    String pass;
    String productName;
    ...
    @Test
    public void testCreateProductHiddenTest(){
        if (ExtentListener.getCurrentTest() != null) {
            ExtentListener.getCurrentTest().assignCategory("testCreateProductHiddenTest");
            ExtentListener.getCurrentTest().getModel().setDescription("testCreateProductHiddenTest description");
        }
        ...
        productPage.hideRemainingStockOnOnlineStore(true);
