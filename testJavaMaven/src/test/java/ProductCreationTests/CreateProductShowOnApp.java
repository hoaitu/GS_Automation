...
public class CreateProductShowOnApp extends BaseTest {
    String name;
    String pass;
    String productName;
    ...
    @Test
    public void testCreateProductShowOnApp(){
        if (ExtentListener.getCurrentTest() != null) {
            ExtentListener.getCurrentTest().assignCategory("testCreateProductShowOnApp");
            ExtentListener.getCurrentTest().getModel().setDescription("testCreateProductShowOnApp description");
        }
