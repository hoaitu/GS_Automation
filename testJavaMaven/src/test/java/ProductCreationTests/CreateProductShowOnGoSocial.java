...
public class CreateProductShowOnGoSocial extends BaseTest {
    String name;
    String pass;
    String productName;
    ...
    @Test
    public void testCreateProductShowOnGoSocial(){
        if (ExtentListener.getCurrentTest() != null) {
            ExtentListener.getCurrentTest().assignCategory("testCreateProductShowOnGoSocial");
            ExtentListener.getCurrentTest().getModel().setDescription("testCreateProductShowOnGoSocial description");
        }
