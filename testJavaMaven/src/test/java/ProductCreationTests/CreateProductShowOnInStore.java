...
public class CreateProductShowOnInStore extends BaseTest {
    String name;
    String pass;
    String productName;
    ...
    @Test
    public void testCreateProductShowOnInStore(){
        if (ExtentListener.getCurrentTest() != null) {
            ExtentListener.getCurrentTest().assignCategory("testCreateProductShowOnInStore");
            ExtentListener.getCurrentTest().getModel().setDescription("testCreateProductShowOnInStore description");
        }
